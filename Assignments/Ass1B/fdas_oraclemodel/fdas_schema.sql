...
CREATE TABLE assessment_damage (
    ...
    pro_id1              NUMBER(7) NOT NULL,
    building_id1         NUMBER(3) NOT NULL
);
...
COMMENT ON COLUMN assessment_damage.pro_id1 IS
    'property ID';

COMMENT ON COLUMN assessment_damage.building_id1 IS
    'building ID';
...
CREATE TABLE assessor (
    ...
    assessor_gname          VARCHAR2(30 BYTE),
    assessor_fname          VARCHAR2(30 BYTE),
...
CREATE TABLE insurer (
    insur_code         NUMBER(7) NOT NULL,
    insur_lname        VARCHAR2(30 BYTE),
    insur_fname        VARCHAR2(30 BYTE),
...
CREATE TABLE visit (
    ...
    pro_id              NUMBER(7) NOT NULL,
    building_id         NUMBER(3) NOT NULL,
    vi_arr_datetime     DATE NOT NULL,
    vi_arr_time         DATE NOT NULL,
    vi_depart_datetime  DATE NOT NULL,
    vi_depart_time      DATE NOT NULL,
    vi_no2              NUMBER(7) NOT NULL,
    pro_id1             NUMBER(7) NOT NULL,
    building_id1        NUMBER(3) NOT NULL,
    fire_event_id       CHAR(9 BYTE) NOT NULL
);
...
COMMENT ON COLUMN visit.vi_arr_datetime IS
    'visit_arrived_date';

COMMENT ON COLUMN visit.vi_arr_time IS
    'visit_arrived_time';

COMMENT ON COLUMN visit.vi_depart_datetime IS
    'visit_depart_date';

COMMENT ON COLUMN visit.vi_depart_time IS
    'visit_depart_time';

COMMENT ON COLUMN visit.vi_no2 IS
    'visit number (surrogate key)';

COMMENT ON COLUMN visit.pro_id1 IS
    'property ID';

COMMENT ON COLUMN visit.building_id1 IS
    'building ID';

COMMENT ON COLUMN visit.fire_event_id IS
    'fire event ID
';
...
ALTER TABLE visit
    ADD CONSTRAINT visit_nk UNIQUE ( vi_arr_datetime,
                                     vi_arr_time,
                                     building_id,
                                     pro_id );
...
ALTER TABLE assessment_damage
    ADD CONSTRAINT building_assessment_damage FOREIGN KEY ( building_id1,
                                                            pro_id1 )
        REFERENCES building ( building_id,
                              pro_id );

ALTER TABLE visit
    ADD CONSTRAINT building_visit FOREIGN KEY ( building_id1,
                                                pro_id1 )
        REFERENCES building ( building_id,
                              pro_id );
...
ALTER TABLE visit
    ADD CONSTRAINT fire_event_visit FOREIGN KEY ( fire_event_id )
        REFERENCES fire_event ( fire_event_id );
