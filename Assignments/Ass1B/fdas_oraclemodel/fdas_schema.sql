...
ALTER TABLE assessment_damage ADD CONSTRAINT assessment_damage_nk UNIQUE ( fire_event_id );
...
ALTER TABLE assessment_damage
    ADD CONSTRAINT building_assessment_damage FOREIGN KEY ( building_id,
                                                            pro_id )
        REFERENCES building ( building_id,
                              pro_id );

ALTER TABLE visit
    ADD CONSTRAINT building_visit FOREIGN KEY ( building_id,
                                                pro_id )
        REFERENCES building ( building_id,
                              pro_id );
